...
**Current Version:** v8.5.2 (build 55)  
...
- When present, the UI shows **Web Server Version: v8.5.2 (build 55)** in the User menu, About, and Admin > System.
...
```
Should return `{"version": "8.5.2", "build": 55, ...}`
