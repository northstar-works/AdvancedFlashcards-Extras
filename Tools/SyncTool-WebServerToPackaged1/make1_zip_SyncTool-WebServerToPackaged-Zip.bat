...
REM Creates ZIP in SAME folder as this BAT:
...
REM Logging
set "LOGDIR=%BASE%\logs\Zip"
if not exist "%LOGDIR%" mkdir "%LOGDIR%" >nul 2>&1
set "LOG=%LOGDIR%\SyncTool-WebServerToPackaged_makezip.log"
> "%LOG%" echo START %DATE% %TIME%
>>"%LOG%" echo BASE=%BASE%

set "VERJSON=%BASE%\version.json"
...
robocopy "%BASE%" "%STAGE%\%ROOTNAME%" /E /R:1 /W:1 /NFL /NDL /NP /NJH /NJS ^
