...
- **Custom Set → Manage Cards responsive layout:** Prevented modal overflow/misalignment on smaller screens by overriding global input min-width and stacking the two panes on narrow widths.

### Changed
- **Confirmation visuals standardized:** **✓** for success, **✖** for error.
